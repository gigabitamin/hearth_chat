    ...
    def ready(self):
        ...
        try:
            ...
            if connection.connection is None:
                print("⚠️ 데이터베이스 연결이 아직 준비되지 않음, Site 패치 건너뜀")
                return
            ...
            try:
                with connection.cursor() as cursor:
                    ...
                    if not cursor.fetchone():
                        print("⚠️ django_site 테이블이 존재하지 않음, Site 패치 건너뜀")
                        return
            except Exception as e:
                print(f"⚠️ 테이블 확인 중 오류: {e}, Site 패치 건너뜀")
                return
            ...
            try:
                ...
                try:
                    ...
                    print(f"⚠️ Site 객체 생성 실패: {e}, 기본값 사용")
                    # 기본 Site 객체 생성 실패 시 더미 객체 사용
                    site = type('MockSite', (), {'id': site_id, 'domain': domain, 'name': name})()
